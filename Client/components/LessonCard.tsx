...
const LessonCard = ({ lesson }: LessonCardProps) => {
  ...
  return (
    <View className={`border-whiteGray flex-row justify-between`}>
      <View className={`w-[25%]`}>
      ...
      <View className={`w-[75%]`}>
        {isSubstituted ? (
          <View>
            <View className="bg-blueGray rounded-t-3xl pt-[10px] pb-[10px] pl-[12px] pr-[12px]">
              ...
              <View className="flex-row mt-[5px] mb-[5px]">
                ...
                <Text className="ml-[5px] font-poppins text-[14px] text-black">
                  Sala {lesson.room}
                </Text>
              </View>
              {lesson.teacher ? (
            ...
            <View className="bg-primary rounded-b-3xl h-[25px] flex justify-center">
              <Text className="ml-[20px] font-poppinsMedium text-[12px] text-white">
                Zastępstwo
              </Text>
            </View>
          </View>
          ...
          <View>
            <View className="bg-blueGray rounded-t-3xl pt-[10px] pb-[10px] pl-[12px] pr-[12px]">
              <Text className="font-poppinsBold text-[16px] text-black line-through">
                {lesson.name}
              </Text>
            </View>
