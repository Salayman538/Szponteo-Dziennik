      ...
      <Tabs.Screen
          ...
          options={{
            tabBarIcon: ({ color, size }) => (
              <Menu color={color} width={24} height={24}/>
            ),
          }}
          listeners={{
            tabPress: e => {
    ...
    <Pressable 
        ...
        <Pressable 
            ...
            <View className='flex-row justify-start mb-[10] ml-[20] mr-[20] mt-[20]'>
                ...
                <TouchableOpacity className='rounded-2xl bg-[#265FEF] h-[66] w-[40%] justify-center items-center'
                 onPress={() => {
                ...
                <TouchableOpacity className='rounded-2xl bg-[#265FEF] h-[66] w-[57.5%] justify-center items-center ml-[10]' 
                onPress={() => {
                  setMenuVisible(false);
                  router.push('/(tabs)');
                  }}>
            ...
            <View className='flex-row justify-start mb-[10] ml-[20] mr-[20]'>
                <TouchableOpacity className='rounded-2xl bg-[#265FEF] h-[66] w-[55%] justify-center items-center' 
                onPress={() => {
                  setMenuVisible(false);
                ...
                <TouchableOpacity className='rounded-2xl bg-[#265FEF] h-[66] w-[42.5%] justify-center items-center ml-[10]' 
                onPress={() => {
                  setMenuVisible(false);
            ...
            <View className='flex-row justify-start ml-[20] mr-[20]'>
                <TouchableOpacity className='rounded-2xl bg-[#265FEF] h-[66] w-[57.5%] justify-center items-center'
                onPress={() => {
                  setMenuVisible(false);
                ...
                <TouchableOpacity className='rounded-2xl bg-[#265FEF] h-[66] w-[40%] justify-center items-center ml-[10]' 
                onPress={() => {
                  setMenuVisible(false);
            ...
            <View className='flex-row justify-end gap-2 items-center h-[21%]'>
                <TouchableOpacity className='rounded-3xl bg-[#265FEF] h-[36] w-[36] justify-center items-center' 
                onPress={() => {
                  setMenuVisible(false);
                ...
                <TouchableOpacity className='rounded-3xl bg-[#265FEF] h-[36] w-[36] justify-center items-center mr-[20]' onPress={() => setMenuVisible(false)}>
